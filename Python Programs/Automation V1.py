...
def detect_edges(image_path, output_path='C:/Users/D00456326/Desktop/Research Photos/Edges/Nanoparticles/Image1 edges.png'):
...
#Counting the contours or "holes"
    ...
    print(f"Number of nanoparticles detected: {holes}")
    return holes
...
def get_hole_areas(edge_image_path, microns_per_pixel=1.0, min_contour_area=10):
    ...
    for idx, area in enumerate(hole_areas_microns, 1):
        print(f"Nanoparticle {idx}: {area:.2f} µm²")

    print(f"Average nanoparticle area: {avg_area:.2f} µm²")
...
image_input_path = "C:/Users/D00456326/Desktop/Research Photos/Nanoparticles/NOCOB1.JPG"
edge_output_path = "C:/Users/D00456326/Desktop/Research Photos/Nanoparticles/NOCOB1 edges.png"

detect_edges(image_input_path, edge_output_path)
count_holes(edge_output_path)
get_hole_areas(edge_output_path, microns_per_pixel=0.17)
